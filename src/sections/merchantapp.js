...
import support from 'assets/images/merchantapp.png';
...
const Services = () => {
  return (
    <Box as="section">
        <SectionHeading
          slogan="Merchant app for offers and payments"
          title="One stop solution for managing offers and receiving BNPL payments"
        />
      <Container>
        <Box sx={styles.grid}>
          <Box sx={styles.content}>
            <Heading sx={styles.title}>
			Accept payments through BNPL apps seamlessly
            </Heading>
            <Text as="p" sx={styles.summary}>
              Get ease of BNPL transaction with BNPL apps through QR code and manage your offers for all the BNPL solutions at one place
            </Text>
