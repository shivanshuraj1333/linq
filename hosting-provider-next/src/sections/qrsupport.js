        ...
        <Box sx={styles.grid}>
          ...
          <Box sx={styles.content}>
            <Heading sx={styles.title}>
              We act as a LinQ between merchants and BNPL providers
            </Heading>
            <Text as="p" sx={styles.summary}>
			We offer a QR gateway for offline and online stores, through which customers can scan and pay using all partner buy now, pay later solutions.
